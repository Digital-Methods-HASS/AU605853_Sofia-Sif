...
This doesn't work because the format has something that is wrong. Therefore I try the following: 
...
I thought it could be interesting to compare the lists of highest shares in 2011 and 2018 to see if something has changed... In conclusion I finished scraping a website and ended up with a nice table, but I did not end up visualizing anything. This is what I need to practice for next time. 
